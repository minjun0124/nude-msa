package com.nutritiondesigner.itemservice.config;

import com.nutritiondesigner.itemservice.jwt.JwtAccessDeniedHandler;
import com.nutritiondesigner.itemservice.jwt.JwtAuthenticationEntryPoint;
import com.nutritiondesigner.itemservice.jwt.JwtSecurityConfig;
import com.nutritiondesigner.itemservice.jwt.TokenProvider;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception {
        httpSecurity
                ...
                .antMatchers(HttpMethod.GET, "/items/new").permitAll()
                .antMatchers(HttpMethod.GET, "/items/health-check").permitAll()
